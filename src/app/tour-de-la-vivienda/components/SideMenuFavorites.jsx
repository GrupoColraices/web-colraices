...
export const SideMenuFavorites = () => {
    return (
        <div className="container-leftBar">
            <Link href={'/tour-de-la-vivienda/favoritos/para-ti'} className="item-rightBar">
                <Image src={medal} alt="rocket" width={40} height={40} />
                <p>Para ti</p>
            </Link>
            <Link href={'/tour-de-la-vivienda/favoritos'} className="item-rightBar">
                <Image src={heart} alt="rocket" width={40} height={40} />
                <p>Mis inmuebles favoritos</p>
            </Link>
            <Link href={'/tour-de-la-vivienda/favoritos/comparar-propiedades'} className="item-rightBar">
