...
export const socialNetworks = [
  ...
  { id: 2, name: 'instagram', url: 'https://www.instagram.com/colraices', src: '/portal-inmobiliario/img/colraicesInmobiliario/icons/instagram.svg' },
  { id: 3, name: 'linkedin', url: 'https://www.linkedin.com/company/colraices/mycompany', src: '/portal-inmobiliario/img/colraicesInmobiliario/icons/linkedin.svg' },
  { id: 4, name: 'whatsapp', url: 'https://api.whatsapp.com/send/?phone=15136479405', src: '/portal-inmobiliario/img/colraicesInmobiliario/icons/whatsapp.svg' },
  { id: 5, name: 'youtube', url: 'https://www.youtube.com/c/Colraicesserviciosinmobiliariosfinancieros', src: '/portal-inmobiliario/img/colraicesInmobiliario/icons/youtube.svg' },

]

export const linksFooter = [
  { id: 1, name: 'Inmuebles', url: '/tour-de-la-vivienda', target: '_blank' },
  { id: 2, name: 'Favoritos', url: '/tour-de-la-vivienda/favoritos', target: '_blank' },
  { id: 3, name: 'Contacto', url: '/contacto', target: '_self' }
]
export const links = [
  { id: 1, label: "Menú", url: "" },
  { id: 2, label: "Home", url: "/" },
  { id: 3, label: "Portal Inmobiliario", url: "/tour-de-la-vivienda" },
  { id: 4, label: "Mis favoritos", url: "/tour-de-la-vivienda/favoritos" },
  // { id: 4, label: "Contactos", url: "#contact" }
]
export const itemsEligenos = [
  {
    id: 1,
    src: '/portal-inmobiliario/img/colraicesInmobiliario/icons/money.svg',
    text: 'Condiciones de lanzamiento y los mejores planes de financiamiento.'
  },
  {
    id: 2,
    src: '/portal-inmobiliario/img/colraicesInmobiliario/icons/figure_model.svg',
    text: 'Inmuebles con visita en tiempo real para que escojas tu casa/apartamento como si estuvieras en Colombia'

  },
  {
    id: 3,
    src: '/portal-inmobiliario/img/colraicesInmobiliario/icons/medal_star.svg',
    text: 'Inmuebles destacados con beneficios para que compres ahora.'
  },
  {
    id: 4,
    src: '/portal-inmobiliario/img/colraicesInmobiliario/icons/swing_figure.svg',
