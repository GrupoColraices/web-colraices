...
import { optionsSchedule } from '@/app/tour-de-la-vivienda/helpers/options'
...
export default function CampaignLeadForm() {
    ...
    const linkWhatsapp =
        'https://api.whatsapp.com/send/?phone=%2B15136479405&text=Hola%2C%20quiero%20reactivarme%20y%20continuar%20con%20el%20acompa%C3%B1amiento.&type=phone_number&app_absent=0'
    const linkWhatsappSucess =
        'https://api.whatsapp.com/send?phone=15136479405&text=Hola%20soy%20colombiano%20en%20el%20exterior%20y%20quiero%20m%C3%A1s%20informaci%C3%B3n%20para%20realizar%20cupo%20de%20cr%C3%A9dito'
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/hubspot/contact-campaign`, {
                method: 'POST',
                headers: {
    ...
    if (submitted) {
        return (
            <section className="campaing-form success-view">
                ...
                <section>
                    <picture>
                        <img src="imagen-agradecimiento.png" alt="Imagen de una casa" />
                    </picture>
                    <div className="response-text-block">
                        ...
                        <p>
                            Con este primer paso, tu futuro en Colombia ya empezó a tomar forma. En breve te
                            contactaremos.
                        </p>
                        <InternalLink
                            options={{
    ...
    return (
        <section className="campaing-form">
            <div className="title-wide">
                ...
                <h1>
                    <span>Colombia siempre será tu casa. </span>Hoy puedes volver a ella transformando tu remesa en una
            ...
            <div className="main-form">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <fieldset className="container-phone">
                                ...
                                />
                                <Tippy animation="scale" theme={'dark'} content="Teléfono del país de residencia">
                    ...
                    <Tippy
                        content={<div style={{ textAlign: 'center' }}>{tooltipContent}</div>}
