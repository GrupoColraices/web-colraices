            ...
            {loading ? <ThemeProvider theme={theme}>
                ...
                <form onSubmit={handleSubmit(onSubmit)} id='form'>
                    <div className='container-fields'>
                        <TitleSection
                            title={"Déjanos tus datos y te contactamos"}
                            span={"Resolvemos tus inquietudes adicionales o recibe ayuda personalizada."} />
                        <fieldset>
                    ...
                    {fields &&
                        <div className='more-fields' data-aos="fade-down" data-aos-duration="500">
                            <img onClick={() => functionsMoreFields()}
                                src="/portal-inmobiliario/img/colraicesInmobiliario/icons/close_circle.svg" alt="Icon" />
