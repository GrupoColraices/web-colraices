...
export const Form = ({ cities: listCities, setLoading }) => {
    ...
    const storageDataSheet = (data) => {
        const scriptURL =
            'https://script.google.com/macros/s/AKfycby-eKee7ynU9TTPOJ5R_AF76v3YtJzy7k8dnT_Jd91AVbxHpSfp06JaPOrrYhxmX6oR/exec'
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Controller
                    ...
                    render={({ field }) => {
                        return (
                            <label className="field-content">
                                Teléfono
                                <PhoneInput {...field} onChange={(v) => field.onChange(v)} placeholder="Teléfono" />
                    ...
                    {optionsProperty?.map((item, id) => (
                        <label htmlFor="typeProperty" key={id}>
                            ...
                            <input
                                ...
                                type="checkbox"
                                value={item}
                                {...register('typeProperty', { required: true })}
                            />
                        </label>
                    ))}
                </div>
            ...
            <div className="grouped-fields">
                ...
                <label htmlFor="stateProperty" className="field-content">
                    Tipo de inmueble
                    <select
                        name="stateProperty"
                        id="stateProperty"
                        {...register('stateProperty', { required: true })}
                        defaultValue=""
                    >
            ...
            <div className="fields-group">
                ...
                />
                <label className="field-content">
                    ¿En cuanto tiempo deseas adquirir el inmueble ?
            ...
            <div className="field-content">
                <details>
                    ...
                    <fieldset>
                        <input
                            className="extra-request"
                            type="text"
                            name="extrarequest"
                            placeholder="Escribe algun peticion extra ... "
                            {...register('extraRequest', { required: false })}
                        />
                    </fieldset>
                </details>
            </div>
